...
-- 数据来源：中国营养学会《中国婴幼儿喂养指南（2022）》/《6月龄内婴儿母乳喂养指南》/ WHO 相关标准
-- ============================================================

-- ============================================================
-- PART 1：月龄饮食指南扩展（guide_stages + guide_food_rules）
-- seed.sql 已包含：6-8月、8-10月、10-12月、12-18月、18-24月 五个阶段
-- 新增：1-3月（纯奶喂养期）、4-6月（准备期）与 24-36月（家庭饮食衔接期）
-- ============================================================

INSERT INTO guide_stages (id, key, label, title, description, feeding_tips_json, qa_json, daily_schedule_json, sort_order) VALUES
('guide-000', '1-3', '1-3月', '1-3个月：纯奶喂养期', '1-3月龄以母乳喂养为首选；无法母乳喂养时，可在医生指导下选择适合月龄的婴儿配方奶。此阶段以奶为唯一营养来源，不需要额外喂水，不应添加米汤、果汁、菜水或辅食；生后数日开始应每日补充维生素D，并按宝宝饥饿与饱足信号顺应喂养。',
  '["1-3月龄以母乳或适合月龄的婴儿配方奶为唯一营养来源，不额外添加米汤、果汁、菜水等","纯母乳喂养一般不需要额外喂水，天气炎热时优先增加喂奶频次","此阶段不添加辅食，等满6月龄后再结合发育信号评估是否引入","生后数日开始每日补充维生素D 10μg（400IU），具体以儿保或医生建议为准"]',
  '[{"q":"天气热时需要给宝宝额外喂水吗？","a":"一般不需要。1-3月龄纯母乳喂养宝宝通常无需额外喂水，若是配方奶喂养也不建议自行额外加水，优先按需增加喂奶并观察尿量、精神状态。"},{"q":"宝宝总想吃奶，是不是母乳不够？","a":"不一定。1-3月龄常见频繁吃奶和猛长期，先按需喂养、观察体重增长、尿量和精神状态；若持续担心摄入不足，应尽快咨询儿保或儿科医生。"},{"q":"母乳不足时可以先加米粉或米汤吗？","a":"不建议。1-3月龄如果母乳不足，应优先补充适合月龄的婴儿配方奶，而不是提前添加米粉、米汤或其他辅食。"}]',
  '[{"time":"06:00","title":"晨间喂奶","description":"按宝宝饥饿信号哺乳或喂配方奶，不强行定量定时"},{"time":"09:00","title":"白天按需喂养","description":"清醒后、觅食或哭闹时及时回应，观察吞咽和满足信号"},{"time":"12:00","title":"午间喂奶","description":"继续以奶为唯一营养来源，暂不添加任何辅食或饮水"},{"time":"18:00","title":"傍晚喂奶","description":"留意尿量、精神状态和体重增长，必要时记录喂养情况"},{"time":"22:00","title":"睡前/夜间喂奶","description":"夜间醒来吃奶很常见，优先顺应喂养，不刻意拉长间隔"}]',
  -1),
...
-- 1-3月 食物规则（纯奶喂养期，以“唯一营养来源”和“禁止额外添加”为主）
INSERT INTO guide_food_rules (id, stage_id, type, title, foods_json) VALUES
('guide-rule-037', 'guide-000', 'recommended', '主要营养来源', '["母乳","适合月龄的婴儿配方奶（无法母乳时）"]'),
('guide-rule-038', 'guide-000', 'forbidden',   '不建议额外添加', '["水","米汤","菜水","果汁","米粉","果泥"]') ON CONFLICT DO NOTHING;
...
('guide-rule-023', 'guide-006', 'cautious',    '谨慎观察后尝试',       '["蛋黄（部分指南建议6个月后引入）","豆腐泥（观察消化情况）"]') ON CONFLICT DO NOTHING;
...
('guide-rule-025', 'guide-003', 'forbidden', '严格禁止', '["蜂蜜","盐（每日<0.5g）","鲜牛奶（1岁后才可引入）","整粒坚果","加工肉类","含糖饮料"]') ON CONFLICT DO NOTHING;

-- 补充原有 8-10月 禁止规则
INSERT INTO guide_food_rules (id, stage_id, type, title, foods_json) VALUES
('guide-rule-026', 'guide-002', 'forbidden',    '严格禁止',     '["蜂蜜","盐","糖","整粒葡萄/坚果","鲜牛奶","加工零食"]'),
('guide-rule-027', 'guide-002', 'recommended',  '适合手指食物', '["蒸软的胡萝卜条","去皮香蕉段","煮熟的豌豆（压扁）","豆腐小方","鸡蛋黄饼小块"]') ON CONFLICT DO NOTHING;

-- 补充原有 6-8月 谨慎规则
INSERT INTO guide_food_rules (id, stage_id, type, title, foods_json) VALUES
('guide-rule-028', 'guide-001', 'cautious',    '谨慎引入',     '["蛋黄（单独引入观察3天）","鱼泥（先从淡水鱼开始）","豆类泥（观察胀气）"]'),
('guide-rule-029', 'guide-001', 'recommended', '优先补铁食材', '["猪肝泥","牛肉泥","高铁婴儿米粉","红肉泥（猪/牛/羊）"]') ON CONFLICT DO NOTHING;
...
('guide-rule-031', 'guide-004', 'cautious',    '谨慎少量尝试',   '["坚果碎（磨细混入食物）","花生酱（薄涂）","带壳海鲜（观察过敏）","菠萝（口腔刺激）","猕猴桃（过敏率较高）"]') ON CONFLICT DO NOTHING;
...
('guide-rule-033', 'guide-005', 'cautious',    '适量少吃',       '["精制白米面（搭配全谷物）","添加糖的烘焙食品","炒菜植物油（每天约5-10g）"]') ON CONFLICT DO NOTHING;

-- 新增 24-36月（2-3岁）阶段
INSERT INTO guide_stages (id, key, label, title, description, feeding_tips_json, qa_json, daily_schedule_json, sort_order) VALUES
('guide-007', '24-36', '24-36月', '24-36个月：家庭饮食衔接期', '2岁后饮食结构逐步向家庭膳食靠拢，重点仍然是规律三餐两点、足量奶制品、低盐少糖和培养自主进食。此阶段更关注长期饮食习惯、户外活动和语言社交中的餐桌参与。',
  '["保持三餐两点节律，零食固定时段，不用甜食安抚情绪","每日继续保证奶及奶制品摄入，搭配全谷物、蔬菜、水果和优质蛋白","继续低盐少糖，避免高糖饮料、油炸零食和重口味外卖","鼓励孩子参与摆餐具、收拾和简单食物选择，培养独立进食能力"]',
  '[{"q":"2岁后可以和大人吃一样的吗？","a":"可以逐步同桌共餐，但仍建议单独少盐少油，避免辛辣、重口味和高糖饮食。家庭膳食结构可以相同，调味强度需要区别对待。"},{"q":"宝宝总想吃零食怎么办？","a":"不要完全放任，也不必靠吼叫控制。把零食放在固定加餐时间，正餐前后不随意加吃，优先选择水果、原味酸奶、全麦面包等低添加食物。"},{"q":"2岁后还需要继续喝奶吗？","a":"需要。2-3岁阶段奶及奶制品仍是钙和优质蛋白的重要来源，但不能替代正餐，建议作为早餐、加餐或睡前固定搭配的一部分。"}]',
  '[{"time":"07:30","title":"早餐","description":"主食 + 蛋/奶 + 水果，少糖少油"},{"time":"10:00","title":"上午加餐","description":"水果或原味酸奶，小份量即可"},{"time":"12:00","title":"午餐","description":"谷薯类 + 肉蛋豆 + 蔬菜，和家人同桌进食"},{"time":"15:30","title":"下午加餐","description":"全麦面包、奶制品或时令水果"},{"time":"18:30","title":"晚餐","description":"清淡家庭餐，避免过晚和高糖零食"}]',
  6) ON CONFLICT DO NOTHING;

INSERT INTO guide_food_rules (id, stage_id, type, title, foods_json) VALUES
('guide-rule-034', 'guide-007', 'recommended', '推荐日常搭配', '["全谷物主食（杂粮饭、全麦面）","鸡蛋","奶及奶制品","瘦肉和鱼虾","豆腐和豆制品","深绿色蔬菜","橙黄色蔬菜","时令水果"]'),
('guide-rule-035', 'guide-007', 'cautious',    '控制频率',     '["蛋糕饼干等高糖烘焙","浓口味酱料","加工肉制品","高盐熟食","含糖酸奶和乳饮料"]'),
('guide-rule-036', 'guide-007', 'forbidden',   '尽量避免',     '["含糖饮料","咖啡因饮品","整粒坚果单独食用","频繁油炸食品","辛辣刺激食物"]') ON CONFLICT DO NOTHING;
...
('symptom-010', '消化不良', '消化不良期饮食建议') ON CONFLICT DO NOTHING;
...
('symptom-rule-011',  'symptom-004', 'recommended', '蒸梨水（温热）',             '润肺生津，有助于缓解发热引起的咽干不适。') ON CONFLICT DO NOTHING;
...
('symptom-rule-019', 'symptom-005', 'recommended', '蒸胡萝卜泥',                 '胡萝卜富含膳食纤维和果胶，有助于调节肠道菌群。') ON CONFLICT DO NOTHING;
...
('symptom-rule-026', 'symptom-006', 'recommended', '高铁婴儿强化米粉',           '每日摄入足量高铁米粉可有效预防6-12月龄铁缺乏，是主要铁来源。') ON CONFLICT DO NOTHING;
...
('symptom-rule-032', 'symptom-007', 'recommended', '已确认安全的蔬菜泥',         '坚持单一食材逐步引入，每种新食材观察3-5天再引入下一种。') ON CONFLICT DO NOTHING;
...
('symptom-rule-036', 'symptom-008', 'recommended', '母乳（首选）',               '急疹期坚持母乳可提供免疫因子，帮助宝宝平稳度过出疹期。') ON CONFLICT DO NOTHING;
...
('symptom-rule-041', 'symptom-009', 'recommended', '软烂的粥类和细面',           '质地柔软不需要过多咀嚼，降低进食痛苦，保证热量摄入。') ON CONFLICT DO NOTHING;
...
('symptom-rule-047', 'symptom-010', 'recommended', '小米粥（去米油单喝）',       '小米粥米油富含维生素B族和不饱和脂肪酸，温和养护胃肠。') ON CONFLICT DO NOTHING;
...
('symptom-rule-060', 'symptom-003', 'recommended', '葱白姜水（极少量）',         '葱白含挥发性硫化物，有轻微发汗解表作用，适合风寒感冒初期。') ON CONFLICT DO NOTHING;
...
('recipe-011', '高铁南瓜米糊',
 ...
 '6个月+', 6, NULL, '10分钟', '初级', '营养师精品', '陈营养师', 1205, '补铁首选，质地需极细腻', 'published', 'approved'),
...
('recipe-012', '红薯泥（第一口）',
 ...
 '6个月+', 6, NULL, '15分钟', '初级', '营养师精品', '王营养师', 987, '首次引入甜味食材，观察接受度', 'published', 'approved'),

('recipe-013', '蛋黄米粉泥',
 '蛋黄富含卵磷脂和DHA，与高铁米粉组合，补铁补脑一步到位，适合6个月后引入。',
 'https://images.unsplash.com/photo-1482049016688-2d3e1b311543?auto=format&fit=crop&w=800&q=80',
 '6个月+', 6, NULL, '12分钟', '初级', '营养师精品', '陈营养师', 743, '先确认蛋黄不过敏再添加米粉', 'published', 'approved'),

-- ── 6-8月（泥糊状，重点补铁）──────────────────────────────────
('recipe-014', '猪肝红薯泥',
 '猪肝血红素铁吸收率高达20%，搭配红薯去腥提甜，是预防缺铁性贫血的明星辅食。',
 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=800&q=80',
 '7个月+', 7, NULL, '20分钟', '中级', '营养师精品', '陈营养师', 1356, '焯水步骤不可省略，去腥彻底', 'published', 'approved'),

('recipe-015', '牛肉西兰花泥',
 '牛肉血红素铁+西兰花维C黄金组合，铁吸收率提升3-5倍，细腻顺滑适合7月龄+。',
 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=800&q=80',
 '7个月+', 7, NULL, '25分钟', '中级', '营养师精品', '刘营养师', 892, '西兰花需去梗只用花冠部分', 'published', 'approved'),

('recipe-016', '三文鱼豆腐泥',
 '三文鱼DHA丰富助大脑发育，嫩豆腐补钙，两者同蒸口感极嫩，去刺需仔细。',
 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?auto=format&fit=crop&w=800&q=80',
 '7个月+', 7, NULL, '18分钟', '中级', '营养师精品', '王营养师', 668, 'DHA补充，去刺操作须详述', 'published', 'approved'),
...
('recipe-017', '香菇鸡肉蔬菜粥',
 ...
 '8个月+', 8, NULL, '30分钟', '初级', '营养师精品', '陈营养师', 1102, '香菇需切极细，观察消化情况', 'published', 'approved'),
...
('recipe-018', '胡萝卜手指条（初级手抓）',
 ...
 '8个月+', 8, NULL, '15分钟', '初级', '营养师精品', '王营养师', 634, '软度标准：两指可轻松压断', 'published', 'approved'),

('recipe-019', '龙利鱼蒸豆腐',
 '龙利鱼无刺DHA丰富，嫩豆腐补钙，整体质地极软，适合咀嚼能力刚起步的宝宝。',
 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&w=800&q=80',
 '8-10月', 8, 10, '20分钟', '初级', '营养师精品', '刘营养师', 821, '龙利鱼无刺优势需在描述中突出', 'published', 'approved'),

('recipe-020', '番茄鸡蛋软面片',
 '番茄酸甜开胃促进食欲，鸡蛋提供优质蛋白，细面片煮至极软，适合8月龄+练习咀嚼。',
 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?auto=format&fit=crop&w=800&q=80',
 '8-10月', 8, 10, '20分钟', '初级', '营养师精品', '陈营养师', 956, '确认鸡蛋不过敏后使用', 'published', 'approved'),
...
('recipe-021', '土豆鸡肉小丸子',
 ...
 '10个月+', 10, NULL, '25分钟', '中级', '营养师精品', '王营养师', 743, '大小控制在直径2cm左右，防窒息', 'published', 'approved'),

('recipe-022', '三鲜豆腐羹',
 '嫩豆腐、虾仁末、青豆泥组合，钙、蛋白质双补，羹状不需咀嚼即可吞咽，适合出牙期。',
 'https://images.unsplash.com/photo-1547592166-f2f1fa7b5f3e?auto=format&fit=crop&w=800&q=80',
 '10-12月', 10, 12, '20分钟', '中级', '营养师精品', '陈营养师', 589, '虾仁先确认不过敏，去虾线处理', 'published', 'approved'),

('recipe-023', '五彩蔬菜蛋饼',
 '鸡蛋+胡萝卜丝+菠菜碎的手指食物，色彩丰富激发食欲，平底锅少油薄摊，适合手抓。',
 'https://images.unsplash.com/photo-1482049016688-2d3e1b311543?auto=format&fit=crop&w=800&q=80',
 '10个月+', 10, NULL, '15分钟', '初级', '营养师精品', '刘营养师', 867, '厚度控制在5mm，便于宝宝抓握', 'published', 'approved'),

-- ── 12-18月（软固体，向家庭餐过渡）───────────────────────────
('recipe-024', '冬瓜虾仁小馄饨',
 '薄皮大馅，冬瓜清热消暑，虾仁补钙提鲜，皮薄馅嫩，适合12月龄+练习咬断能力。',
 'https://images.unsplash.com/photo-1569050467447-ce54b3bbc37d?auto=format&fit=crop&w=800&q=80',
 '12个月+', 12, NULL, '35分钟', '中级', '营养师精品', '王营养师', 512, '虾仁剁至极碎，馄饨大小适中', 'published', 'approved'),

('recipe-025', '黑芝麻芋头泥',
 '芋头补钾富含膳食纤维，熟黑芝麻碎提供优质油脂和钙质，口感绵密香浓，适合12月龄+。',
 'https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&w=800&q=80',
 '12个月+', 12, NULL, '20分钟', '初级', '营养师精品', '陈营养师', 445, '芋头需戴手套处理，防止皮肤过敏', 'published', 'approved'),
...
('recipe-026', '西兰花牛肉软饭',
 ...
 '12个月+', 12, NULL, '30分钟', '初级', '营养师精品', '刘营养师', 688, '牛肉需焖至可轻松用舌头压碎', 'published', 'approved'),

('recipe-027', '什锦蔬菜蛋卷',
 '鸡蛋薄饼包裹菠菜末、胡萝卜丝、香菇碎，手指食物锻炼抓握，多色蔬菜营养均衡。',
 'https://images.unsplash.com/photo-1482049016688-2d3e1b311543?auto=format&fit=crop&w=800&q=80',
 '15个月+', 15, NULL, '20分钟', '中级', '营养师精品', '王营养师', 423, '卷紧后切段，直径约2.5cm方便抓握', 'published', 'approved'),

-- ── 18-24月（接近成人食物）────────────────────────────────────
('recipe-028', '番茄牛肉疙瘩汤',
 '番茄红素+牛肉铁质+面疙瘩碳水，酸甜浓汤开胃，适合18月龄+，全家可一起吃（少盐版）。',
 'https://images.unsplash.com/photo-1512058564366-18510be2db19?auto=format&fit=crop&w=800&q=80',
 '18个月+', 18, NULL, '35分钟', '中级', '营养师精品', '陈营养师', 534, '宝宝份额不加盐，成人另行调味', 'published', 'approved'),
...
('recipe-029', '燕麦水果粥',
 ...
 '18个月+', 18, NULL, '15分钟', '初级', '营养师精品', '刘营养师', 612, '选用无添加纯燕麦片，非即食冲泡款', 'published', 'approved'),

('recipe-030', '彩椒鸡肉炒软饭',
 '红黄彩椒维C丰富，鸡肉提供蛋白质，少油翻炒软米饭，颜色鲜亮激发18月龄+宝宝食欲。',
 'https://images.unsplash.com/photo-1512058564366-18510be2db19?auto=format&fit=crop&w=800&q=80',
 '18个月+', 18, NULL, '25分钟', '中级', '营养师精品', '王营养师', 398, '彩椒去皮后更易消化，不加任何调味盐', 'published', 'approved'),
...
('recipe-031', '焦米粥（腹泻专用）',
 ...
 '6个月+', 6, NULL, '30分钟', '初级', '营养师精品', '陈营养师', 789, '腹泻专用，效果需在描述中说明机理', 'published', 'approved'),
...
('recipe-032', '蒸梨银耳羹（润肺止咳）',
 ...
 '10个月+', 10, NULL, '40分钟', '初级', '营养师精品', '刘营养师', 456, '银耳需充分泡发至无硬心', 'published', 'approved'),

('recipe-033', '山药小米南瓜粥（积食调理）',
 '山药健脾护胃，小米养胃易消化，南瓜提供天然甜味，积食期三餐替换粥类减轻肠胃负担。',
 'https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&w=800&q=80',
 '7个月+', 7, NULL, '25分钟', '初级', '营养师精品', '王营养师', 634, '积食调理，粥稠度根据症状调节', 'published', 'approved'),

('recipe-034', '西梅燕麦泥（通便专用）',
 '西梅山梨醇天然通便，燕麦β-葡聚糖软化粪便，两者搭配是婴幼儿便秘的温和食疗首选。',
 'https://images.unsplash.com/photo-1490474418585-ba9bad8fd0ea?auto=format&fit=crop&w=800&q=80',
 '8个月+', 8, NULL, '15分钟', '初级', '营养师精品', '陈营养师', 567, '通便专用，西梅需选无添加纯果泥', 'published', 'approved'),

('recipe-035', '菠菜猪肝蛋黄泥（补铁强化）',
 '猪肝+蛋黄双铁源叠加，菠菜焯水后维C促进铁吸收，是缺铁性贫血期的强化补铁方案。',
 'https://images.unsplash.com/photo-1515003197210-e0cd71810b5f?auto=format&fit=crop&w=800&q=80',
 '8个月+', 8, NULL, '25分钟', '中级', '营养师精品', '刘营养师', 712, '补铁强化专用，猪肝每周不超过2次', 'published', 'approved') ON CONFLICT DO NOTHING;
...
-- recipe-035 菠菜猪肝蛋黄泥
('tag-093', 'recipe-035', '强化补铁'), ('tag-094', 'recipe-035', '预防贫血'), ('tag-095', 'recipe-035', '维C促吸收') ON CONFLICT DO NOTHING;
...
('ing-107', 'recipe-035', '柠檬汁（去腥）', '几滴', NULL) ON CONFLICT DO NOTHING;
...
('step-154', 'recipe-035', 3, '混合打泥', '将猪肝、焯水菠菜、熟蛋黄一起加少量温水打成细泥过筛，猪肝每周摄入不超过2次。',
 'https://images.unsplash.com/photo-1515003197210-e0cd71810b5f?auto=format&fit=crop&w=800&q=80') ON CONFLICT DO NOTHING;
