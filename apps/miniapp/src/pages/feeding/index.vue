...
function goRecordPage() {
  openProtectedPage('/pages/record/index')
}
  ...
  <view class="page-shell feeding-page">
    ...
    <view v-else class="logged-view">
      ...
      <view class="quick-grid">
        ...
        <view class="quick-card soft-card accent" @tap="goRecordPage">
          <text class="quick-icon">📝</text>
          <text class="quick-title">喂养记录</text>
          <text class="quick-desc">奶量、辅食、饮水和补剂都记这里</text>
        </view>
        <view class="quick-card soft-card" @tap="goRecipeLibrary">
          <text class="quick-icon">🥣</text>
          <text class="quick-title">食谱库</text>
